...
我们网站的是 NOC 2011 版和 ANZSCO 2011 版。要查官网。

### 职业分类使用方法

- 结合学历，专业和职业title（职责）等关键词在官网搜索
- 深入了解职业分类，快速记忆职业代码，通过职业代码大致判断职业

### Skill level

NOC： 第二位代表职业的技能级别
ANZSCO： 第一位大致代表了技能级别，具体职业的技能级别需要进一步看

#### NOC 代码分解

- 第一位，主要行业（大类）
- 第二位，技能级别（Skill Level）
- 第三位，行业细分（小类）
- 第四位，具体职业

#### NOC 十大主要行业

0. 管理职业(横跨1-8类职业，第二位从0-9)
1. 商业，财务和行政职业
2. 自然和应用科学相关职业
3. 医疗卫生行业
4. 社科，教育，政府服务和宗教职业
...
1-9 类属于主要行业的职业，第二位代码从1-7。3位和4位属于平行分类，没有明显等级特征。

#### NOC 五大技能级别 SKILL LEVEL

* SKILL LEVEL 0：管理职业，涉及各行各业
* SKILL LEVEL A：需要大学教育
* SKILL LEVEL B：需要大专以上学历或学徒训练
* SKILL LEVEL C：需要中学和/或职业培训
* SKILL LEVEL D：通常只要求完成在职培训

#### 快速判断 NOC Skill Level
...
了解 NOC Matrix 有利于系统掌握 NOC 职业分类: http://noc.esdc.gc.ca/English/NOC/Matrix2016.aspx?ver=16

### ANZSCO 职业分类

Group | 职业中文名 - FLYabroad | 职业英文名 - FLYabroad | 技能级别
------|-------------------|-------------------|-----
1 | 管理职业 | Managers | 1, 2
2 | 专业技术职业 | Professionals | 1
3 | 技师技工职业 | Technicians and Trades Workers | 2, 3
4 | 社区和个人服务职业 | Community and Personal Service Workers | 2, 3, 4, 5
5 | 文秘行政职业 | Clerical and Administrative Workers | 2, 3, 4, 5
6 | 销售职业 | Sales Workers | 2, 3, 4, 5
7 | 机械操作和驾驶员职业 | Machinery Operators and Drivers | 4
8 | 体力劳工职业 | Labourers | 4, 5
...
**举例，261313 软件工程师职业代码分解**

- 第一位，2 专业人员
- 前二位，26 信息与通信技术专业人员
- 前三位，261 ICT 业务分析和程序员
- 前四位，2613 软件和应用程序员，前4位代码想通过叫相关职业
- 第五、六位共同组成一个具体职业，公用4位 unit group 职业的共性职责，但侧重点不同，261313 软件工程师
...
#### 26 信息与通信技术专业人员 ICT PROFESSIONALS

* 261 ICT 业务分析和程序员，包括业务分析师，系统分析师，多媒体专家，web开发人员，程序员，软件工程师，测试工程师及其他未分类软件程序员
* 262 ICT 专业人员，包括数据库管理员，信息系统安全专家，系统管理员
* 263 ICT 网络和技术支持，包括网络和系统工程师，管理管理员，网络分数师，信息和通信支持，测试和质量保证

##### 2613 软件和应用程序员 Software and Applications Programmers

职业 | 职业细节说明 － 飞出国
---|-------------
261311 | 分析程序员，分析用户需求，生成需求文档和系统规划，编码，测试，调试，维护和文档化程序和应用。
261312 | 开发程序员，解释规范，技术设计和流程图，构建，维护和修改软件应用程序的代码中，从业务功能模型构建技术指标和测试，编写技术文档。
261313 | 软件工程师，设计，开发，修改，文档化，测试，实现，安装和支持软件应用和系统。
261314 | 软件测试员，指定，开发并编写测试计划和测试脚本，生成测试用例，进行回归测试，并且使用自动化测试的软件应用程序来测试行为，功能和计算机软件的完整性，并在缺陷报告和相关文件记录测试结果。

https://github.com/flymember/flymgr/issues/1337

#### ANZSCO 和 NOC 职业对应举例

工作中要经常对 ANZSCO 职业和 NOC 职业进行对应，参考两个职业分类对同类职业的定义。
...
NOC 500 个 unit group，ANZSCO 358 个 unit group，并不是所有NOC和ANZSCO上的职业都可以申请技术移民。
